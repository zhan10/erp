...
public class ProductsAction extends GenericActionSupport {
	private static final long serialVersionUID = 1L;
	private static final Logger log = LoggerFactory
			.getLogger(ProductsAction.class);
	...
	public void save() {
		...
		cn.com.topit.gl.dao.Products products;
		...
		try {
			...
			products = service.saveByJSONObject(jsonObject);
			response.getWriter().print(
					"{success:true,topit_ext_id:" + products.getId() + "}");
