...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="serve.id"/>'],
		[ 'state', '<s:text name="serve.state"/>'],
		[ 'serviceType', '<s:text name="serve.serviceType"/>'],
		[ 'name', '<s:text name="serve.name"/>'],
		[ 'phone', '<s:text name="serve.phone"/>'],
		[ 'eMail', '<s:text name="serve.eMail"/>'],
		[ 'data', '<s:text name="serve.data"/>'],
		[ 'demandDescription', '<s:text name="serve.demandDescription"/>']
	];
