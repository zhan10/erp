...
<script>
	...
	var searchColumns = [
		...
		[ 'tel', '<s:text name="vOrders.tel"/>'],
		[ 'ordersTime', '<s:text name="vOrders.ordersTime"/>'],
		[ 'arrTime', '<s:text name="vOrders.arrTime"/>'],
		[ 'address', '<s:text name="vOrders.address"/>'],
		[ 'memo', '<s:text name="vOrders.memo"/>'],
		[ 'buildingId', '<s:text name="vOrders.buildingId"/>'],
		[ 'bookingId', '<s:text name="vOrders.bookingId"/>'],
		[ 'consumerId', '<s:text name="vOrders.consumerId"/>']
	];
