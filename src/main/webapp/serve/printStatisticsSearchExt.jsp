...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="printStatistics.id"/>'],
		...
		[ 'printCount', '<s:text name="printStatistics.printCount"/>'],
		[ 'price', '<s:text name="printStatistics.price"/>'],
		[ 'priceTotal', '<s:text name="printStatistics.priceTotal"/>'],
	];
