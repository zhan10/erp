...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="rechargeRecord.id"/>'],
		[ 'consumerId', '<s:text name="rechargeRecord.consumerId"/>'],
		[ 'rechargeTime', '<s:text name="rechargeRecord.rechargeTime"/>'],
		[ 'amount', '<s:text name="rechargeRecord.amount"/>'],
		[ 'bookingId', '<s:text name="rechargeRecord.bookingId"/>'],
		[ 'memo', '<s:text name="rechargeRecord.memo"/>'],
		[ 'relatedId', '<s:text name="rechargeRecord.relatedId"/>']
	];
