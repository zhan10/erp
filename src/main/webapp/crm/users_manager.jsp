...
<body>
	<script language="javascript">
		...
		Ext.onReady(function() {
			...
			ds = getDs(mainFields, 'hr/users!managerExt', baseSql,order);
			ds.load();
			...
			tbar = Ext.create('Ext.toolbar.Toolbar',{
				...
				var delAction = Ext.create('Ext.Action', {
					iconCls: 'delete',
					 text: '删除',
						handler: function(widget, event) {   
						delFromDB(ds,sm,'hr/users!delete',function(){});
					}
				});
				var contextMenu = Ext.create('Ext.menu.Menu', {
					 items: [
						showAction,'-'
						<sec:authorize url="/hr/users!add">,addAction,copyAddAction</sec:authorize>
						<sec:authorize url="/hr/users!edit">,editAction</sec:authorize>
						<sec:authorize url="/hr/users!del">,delAction</sec:authorize>
					 ]
				});
