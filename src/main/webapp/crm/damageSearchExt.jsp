...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="damage.id"/>'],
		[ 'bookingId', '<s:text name="damage.bookingId"/>'],
		[ 'consumerId', '<s:text name="damage.consumerId"/>'],
		[ 'payTime', '<s:text name="damage.payTime"/>'],
		[ 'digest', '<s:text name="damage.digest"/>'],
		[ 'payment', '<s:text name="damage.payment"/>'],
		[ 'memo', '<s:text name="damage.memo"/>']
	];
