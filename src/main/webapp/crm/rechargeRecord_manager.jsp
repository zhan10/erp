...
<head>
	...
	<%@ include file="rechargeRecordDefine.jsp"%>
	<%@ include file="rechargeRecordDataExt.jsp"%>
	<%@ include file="rechargeRecordFormExt.jsp"%>
	<%@ include file="rechargeRecordSearchExt.jsp"%>
</head>
<body>
	<script language="javascript">
		...
		Ext.onReady(function() {
			...
			ds = getDs(mainFields, 'crm/rechargeRecord!managerExt', baseSql,order);
			ds.load();
			...
			tbar = Ext.create('Ext.toolbar.Toolbar',{
				...
				var contextMenu = Ext.create('Ext.menu.Menu', {
					 items: [
						showAction,'-'
						<sec:authorize url="/crm/rechargeRecord!add">,addAction,copyAddAction</sec:authorize>
						<sec:authorize url="/crm/rechargeRecord!edit">,editAction</sec:authorize>
						<sec:authorize url="/crm/rechargeRecord!del">,delAction</sec:authorize>
					 ]
				});
