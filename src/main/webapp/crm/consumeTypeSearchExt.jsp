...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [		
		[ 'code', '<s:text name="consumeType.code"/>'],
		[ 'name', '<s:text name="consumeType.name"/>'],
		[ 'chargeType', '<s:text name="consumeType.chargeType"/>'],
		[ 'chargeUnit', '<s:text name="consumeType.chargeUnit"/>'],
		[ 'price', '<s:text name="consumeType.price"/>'],
	];
