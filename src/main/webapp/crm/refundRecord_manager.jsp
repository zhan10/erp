...
<head>
	...
	<%@ include file="refundRecordDefine.jsp"%>
	<%@ include file="refundRecordDataExt.jsp"%>
	<%@ include file="refundRecordFormExt.jsp"%>
	<%@ include file="refundRecordSearchExt.jsp"%>
</head>
<body>
	<script language="javascript">
		...
		Ext.onReady(function() {
			...
			ds = getDs(mainFields, 'crm/refundRecord!managerExt', baseSql,order);
			ds.load();
			...
			tbar = Ext.create('Ext.toolbar.Toolbar',{
				...
				var contextMenu = Ext.create('Ext.menu.Menu', {
					 items: [
						showAction,'-'
						<sec:authorize url="/crm/refundRecord!add">,addAction,copyAddAction</sec:authorize>
						<sec:authorize url="/crm/refundRecord!edit">,editAction</sec:authorize>
						<sec:authorize url="/crm/refundRecord!del">,delAction</sec:authorize>
					 ]
				});
