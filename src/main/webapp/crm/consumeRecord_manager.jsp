...
<head>
	...
	<%@ include file="consumeRecordDefine.jsp"%>
	<%@ include file="consumeRecordDataExt.jsp"%>
	<%@ include file="consumeRecordFormExt.jsp"%>
	<%@ include file="consumeRecordSearchExt.jsp"%>
</head>
<body>
	<script language="javascript">
		...
		Ext.onReady(function() {
			...
			ds = getDs(mainFields, 'crm/consumeRecord!managerExt', baseSql,order);
			ds.load();
			...
			tbar = Ext.create('Ext.toolbar.Toolbar',{
				...
				var contextMenu = Ext.create('Ext.menu.Menu', {
					 items: [
						showAction,'-'
						<sec:authorize url="/crm/consumeRecord!add">,addAction,copyAddAction</sec:authorize>
						<sec:authorize url="/crm/consumeRecord!edit">,editAction</sec:authorize>
						<sec:authorize url="/crm/consumeRecord!del">,delAction</sec:authorize>
					 ]
				});
