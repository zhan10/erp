...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="refundRecord.id"/>'],
		[ 'consumerId', '<s:text name="refundRecord.consumerId"/>'],
		[ 'refundTime', '<s:text name="refundRecord.refundTime"/>'],
		[ 'amount', '<s:text name="refundRecord.amount"/>'],
		[ 'bookingId', '<s:text name="refundRecord.bookingId"/>'],
		[ 'memo', '<s:text name="refundRecord.memo"/>'],
		[ 'relatedId', '<s:text name="refundRecord.relatedId"/>'],
		[ 'relatedType', '<s:text name="refundRecord.relatedType"/>']
	];
