...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="consumer.id"/>'],
		[ 'type', '<s:text name="consumer.type"/>'],
		[ 'points', '<s:text name="consumer.points"/>'],
		[ 'name', '<s:text name="consumer.name"/>'],
		[ 'loginName', '<s:text name="consumer.loginName"/>'],
		[ 'pwd', '<s:text name="consumer.pwd"/>'],
		[ 'tel', '<s:text name="consumer.tel"/>'],
		[ 'email', '<s:text name="consumer.email"/>'],
		[ 'address', '<s:text name="consumer.address"/>'],
		[ 'certificate', '<s:text name="consumer.certificate"/>'],
		[ 'certificateCode', '<s:text name="consumer.certificateCode"/>'],
		[ 'cardType', '<s:text name="consumer.cardType"/>'],
		[ 'cardCode', '<s:text name="consumer.cardCode"/>'],
		[ 'balance', '<s:text name="consumer.balance"/>'],
		[ 'pic', '<s:text name="consumer.pic"/>']
	];
