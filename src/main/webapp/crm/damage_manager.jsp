...
<head>
	...
	<%@ include file="damageDefine.jsp"%>
	<%@ include file="damageDataExt.jsp"%>
	<%@ include file="damageFormExt.jsp"%>
	<%@ include file="damageSearchExt.jsp"%>
</head>
<body>
	<script language="javascript">
		...
		Ext.onReady(function() {
			...
			ds = getDs(mainFields, 'crm/damage!managerExt', baseSql,order);
			ds.load();
			...
			tbar = Ext.create('Ext.toolbar.Toolbar',{
				...
				var contextMenu = Ext.create('Ext.menu.Menu', {
					 items: [
						showAction,'-'
						<sec:authorize url="/crm/damage!add">,addAction,copyAddAction</sec:authorize>
						<sec:authorize url="/crm/damage!edit">,editAction</sec:authorize>
						<sec:authorize url="/crm/damage!del">,delAction</sec:authorize>
					 ]
				});
