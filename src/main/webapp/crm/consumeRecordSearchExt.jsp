...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="consumeRecord.id"/>'],
		[ 'consumeType', '<s:text name="consumeRecord.consumeType"/>'],
		[ 'consumeFrom', '<s:text name="consumeRecord.consumeFrom"/>'],
		[ 'consumeTo', '<s:text name="consumeRecord.consumeTo"/>'],
		[ 'consumerId', '<s:text name="consumeRecord.consumerId"/>'],
		[ 'bookingId', '<s:text name="consumeRecord.bookingId"/>'],
		[ 'relatedId', '<s:text name="consumeRecord.relatedId"/>']
	];
