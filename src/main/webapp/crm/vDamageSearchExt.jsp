...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="vDamage.id"/>'],
		[ 'consumerName', '<s:text name="vDamage.consumerName"/>'],
		[ 'payTime', '<s:text name="vDamage.payTime"/>'],
		[ 'code', '<s:text name="vDamage.code"/>'],
		[ 'digest', '<s:text name="vDamage.digest"/>'],
		[ 'payment', '<s:text name="vDamage.payment"/>'],
		[ 'memo', '<s:text name="vDamage.memo"/>'],
		[ 'bookingId', '<s:text name="vDamage.bookingId"/>'],
		[ 'consumerId', '<s:text name="vDamage.consumerId"/>']
	];
