...
Ext.onReady(function() {	
	var item=Ext.create('Ext.Panel',{title:'',autoScroll:true,hidden:true});
			var item1 = Ext.create('Ext.Panel', {
				title : '库存管理',autoScroll :true,
				//html : '&lt;empty panel&gt;',
				items : [{
					xtype : 'label',
					html : '<a href="inventory/vInventory_manager" target="rightFrame"><img src="img/nav/od2.png" width=48,height=48/><br>入库管理</a><br><br>'
				},
				{
					xtype : 'label',
					html : '<a href="inventory/vInventory_manager1" target="rightFrame"><img src="img/nav/od2.png" width=48,height=48/><br>出库管理</a><br><br>'
				}
				],
				cls : 'empty'
			});
			var accordion = Ext
					.create(
							'Ext.Panel',
							{
								...
								title : '库存管理',									
								itemCls:'required',
								items : [ <sec:authorize url="/mateType/A">item1</sec:authorize>],
								listeners : {
