...
<body>
	<script language="javascript">
		...
		Ext.onReady(function() {
			...
			ds = getDs(mainFields, 'warehouse/vErpOrders!managerExt', baseSql,order);
			ds.load();
					 ...
					 text: '删除',
						handler: function(widget, event) {   
							...
							if(ordersCode.substring(0, 1)=="N"){
								...
								updateStatus("warehouse/erpOrders!save",rec,'删除','您是否确认删除此订单，请仔细核对订单！',status,"订单删除成功!")
							}else{
								Ext.MessageBox.alert('错误', '无法删除该订单！');
							}
						//delFromDB(ds,sm,'warehouse/vErpOrders!delete',function(){});
					}
				});
