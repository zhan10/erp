...
<body>
	<script language="javascript">
		...
		Ext.onReady(function() {
			...
			ds = getDs(mainFields, 'plant/vErpOrders!managerExt', baseSql,order);
			ds.load();
			...
			tbar = Ext.create('Ext.toolbar.Toolbar',{
				...
				items : [
					...
					}),
					{
						...
						'->','-'
						<sec:authorize url="/plant/vErpOrders!del">
						,Ext.create('Ext.Button', {
							...
							handler : function(){
								...
								updateStatus("design/erpOrders!save",rec,'驳回','您是否确认驳回此订单，请仔细核对订单！',status,"订单驳回成功!")
							}
						})
						</sec:authorize>
					]
				...
				var delAction = Ext.create('Ext.Action', {
					iconCls: 'delete',
					 text: '删除',
						...
						//delFromDB(ds,sm,'plant/vErpOrders!delete',function(){});
					}
				});
				var contextMenu = Ext.create('Ext.menu.Menu', {
					 items: [
						showAction,'-'
						/* <sec:authorize url="/plant/vErpOrders!del">,delAction</sec:authorize> */
					 ]
				});
