...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="vWorkbench.id"/>'],
		[ 'typeId', '<s:text name="vWorkbench.typeId"/>'],
		[ 'name', '<s:text name="vWorkbench.name"/>'],
		[ 'intro', '<s:text name="vWorkbench.intro"/>'],
		[ 'floorId', '<s:text name="vWorkbench.floorId"/>'],
		[ 'pic', '<s:text name="vWorkbench.pic"/>'],
		[ 'workbenchType', '<s:text name="vWorkbench.workbenchType"/>'],
		[ 'floorName', '<s:text name="vWorkbench.floorName"/>'],
		[ 'buildingName', '<s:text name="vWorkbench.buildingName"/>'],
		[ 'areaName', '<s:text name="vWorkbench.areaName"/>'],
		[ 'cityName', '<s:text name="vWorkbench.cityName"/>']
	];
