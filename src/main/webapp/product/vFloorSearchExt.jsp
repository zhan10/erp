...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="vFloor.id"/>'],
		[ 'buildingName', '<s:text name="vFloor.buildingName"/>'],
		[ 'name', '<s:text name="vFloor.name"/>'],
		[ 'intro', '<s:text name="vFloor.intro"/>'],
	/* 	[ 'cityName', '<s:text name="vFloor.cityName"/>'],
		[ 'areaName', '<s:text name="vFloor.areaName"/>'], */
		[ 'pic', '<s:text name="vFloor.pic"/>'],
		[ 'buildingId', '<s:text name="vFloor.buildingId"/>'],
/* 		[ 'areaId', '<s:text name="vFloor.areaId"/>'],
		[ 'cityId', '<s:text name="vFloor.cityId"/>'] */
	];
