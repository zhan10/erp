...
<head>
	...
	<%@ include file="officeTypeDefine.jsp"%>
	<%@ include file="officeTypeDataExt.jsp"%>
	<%@ include file="officeTypeFormExt.jsp"%>
	<%@ include file="officeTypeSearchExt.jsp"%>
</head>
<body>
	<script language="javascript">
		...
		Ext.onReady(function() {
			...
			ds = getDs(mainFields, 'product/officeType!managerExt', baseSql,order);
			ds.load();
			...
			tbar = Ext.create('Ext.toolbar.Toolbar',{
				...
				items : [
					...
					}),
					{
						...
						,getDelButton(ds, sm, 'product/officeType!delete','删除')
						</sec:authorize>
