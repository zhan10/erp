...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="vOffice.id"/>'],
		[ 'officeType', '<s:text name="vOffice.officeType"/>'],
		[ 'typeId', '<s:text name="vOffice.typeId"/>'],
		[ 'name', '<s:text name="vOffice.name"/>'],
		[ 'intro', '<s:text name="vOffice.intro"/>'],
		[ 'floorId', '<s:text name="vOffice.floorId"/>'],
		[ 'pic', '<s:text name="vOffice.pic"/>'],
		[ 'persons', '<s:text name="vOffice.persons"/>'],
		[ 'floorName', '<s:text name="vOffice.floorName"/>'],
		[ 'buildingId', '<s:text name="vOffice.buildingId"/>'],
		[ 'buildingName', '<s:text name="vOffice.buildingName"/>'],
		[ 'areaId', '<s:text name="vOffice.areaId"/>'],
		[ 'areaName', '<s:text name="vOffice.areaName"/>'],
		[ 'cityId', '<s:text name="vOffice.cityId"/>'],
		[ 'cityName', '<s:text name="vOffice.cityName"/>']
	];
