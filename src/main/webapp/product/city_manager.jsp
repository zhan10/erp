...
<%@ include file="cityDefine.jsp"%>
<%@ include file="cityDataExt.jsp"%>
<%@ include file="cityFormExt.jsp"%>
<%@ include file="citySearchExt.jsp"%>
</head>
<body>
	<script language="javascript">
		...
		Ext.onReady(function() {
			...
			ds = getDs(mainFields, 'product/city!managerExt', baseSql,order);
			ds.load();
			...
			tbar = Ext.create('Ext.toolbar.Toolbar',{
				padding : '5 0 5 10',
				items : [
					/* getTextField('name', 100, '',0, '<s:text name="city.name" />'),
					'-', */
					Ext.create('Ext.form.field.ComboBox',{
						...
						store : [
							['','选择排序' ]
							,['serviceName', '<s:text name="city.serviceName" />']
						]
					}),
					Ext.create('Ext.form.field.ComboBox',{
						itemId : 'orderType',
					...
					}),
					{
						...
						'->'/* ,'-'
						<sec:authorize url="/product/city!add">
						...
						<sec:authorize url="/product/city!edit">
						...
						/* <sec:authorize url="/product/city!del">
						,getDelButton(ds, sm, 'product/city!delete','删除')
						</sec:authorize> 
				...
				var delAction = Ext.create('Ext.Action', {
					iconCls: 'delete',
					 text: '删除',
						handler: function(widget, event) {   
						delFromDB(ds,sm,'product/city!delete',function(){});
					}
				});
				var contextMenu = Ext.create('Ext.menu.Menu', {
					 items: [
						showAction,'-'
						/* <sec:authorize url="/product/city!add">,addAction,copyAddAction</sec:authorize> */
						<sec:authorize url="/product/city!edit">,editAction</sec:authorize>
						/* <sec:authorize url="/product/city!del">,delAction</sec:authorize> */
					 ]
				});
