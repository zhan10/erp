		...
		items : [
			...
			{name:'areaId',hidden:true},{name:'cityId',hidden:true},
			{
				...
				items : [
				{
								...
								name : 'buildingId',
								fieldLabel : '<s:text name="vVipRoom.buildingName"/>',
								xtype : 'combo',
								value : '',
								selectOnFocus : true,
								displayField : 'name',
								...
								fieldLabel : '<s:text name="vVipRoom.floorName"/>',
								xtype : 'combo',
								value : '',
								selectOnFocus : true,
								displayField : 'name',
				...
				items : [
					{
						...
						allowBlank:false,
						name:'name',
						fieldLabel:'<s:text name="vVipRoom.name"/>'
					}
				]
			},
			{
				...
				items : [
					{
						...
						name:'galleryful',
						fieldLabel:'<s:text name="vVipRoom.galleryful"/>'
					}
			...
			},
			{
				...
				items : [{
							...
							name : 'equipment',
							itemId : 'equipment',
							fieldLabel : '<s:text name="vVipRoom.equipment"/>',
							xtype : 'combo',
							value : '',
				...
				items : [
					{
						flex:1,
						name:'intro',
						fieldLabel:'<s:text name="vVipRoom.intro"/>'
	...
	buttons : [
			{
				...
				handler : function() {
					var saveForm = this.up('form');
					if (saveForm.getForm().isValid()) {
						saveFormToDB(saveForm, 'product/vipRoom!save', grid);
					}
				}
			}, {
				text : '关闭',
