		...
		items : [
			...
			{name:'areaId',hidden:true},{name:'cityId',hidden:true},
			{
				...
				items : [
				{
								...
								name : 'buildingId',
								fieldLabel : '<s:text name="vExhibitionRoom.buildingName"/>',
								xtype : 'combo',
								value : '',
								selectOnFocus : true,
								displayField : 'name',
								...
								fieldLabel : '<s:text name="vExhibitionRoom.floorName"/>',
								xtype : 'combo',
								value : '',
								selectOnFocus : true,
								displayField : 'name',
				...
				items : [
					{
						...
						allowBlank:false,
						name:'name',
						fieldLabel:'<s:text name="vExhibitionRoom.name"/>'
					}
				]
			},
			{
				...
				items : [
					{
						...
						name:'galleryful',
						fieldLabel:'<s:text name="vExhibitionRoom.galleryful"/>'
					}
			...
			},
			{
				...
				items : [{
							...
							name : 'equipment',
							itemId : 'equipment',
							fieldLabel : '<s:text name="vExhibitionRoom.equipment"/>',
							xtype : 'combo',
							value : '',
				...
				items : [
					{
						flex:1,
						name:'intro',
						fieldLabel:'<s:text name="vExhibitionRoom.intro"/>'
					...
					handler : function() {
						...
						if (saveForm.getForm().isValid()) {
							saveFile(saveForm, 'uploadFile', fileTypes,
									'product/exhibitionRoom!saveImg', grid);
						}
					}
				}, {
					text : '关闭',
	...
	buttons : [
			{
				...
				handler : function() {
					var saveForm = this.up('form');
					if (saveForm.getForm().isValid()) {
						saveFormToDB(saveForm, 'product/exhibitionRoom!save', grid);
					}
				}
			}, {
				text : '关闭',
