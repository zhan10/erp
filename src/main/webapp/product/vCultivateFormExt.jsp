		...
		items : [
			...
			{name:'areaId',hidden:true},{name:'cityId',hidden:true},
			{
				...
				items : [
				{
								...
								name : 'buildingId',
								fieldLabel : '<s:text name="vCultivateManager.buildingName"/>',
								xtype : 'combo',
								value : '',
								selectOnFocus : true,
								displayField : 'name',
								...
								fieldLabel : '<s:text name="vCultivateManager.floorName"/>',
								xtype : 'combo',
								value : '',
								selectOnFocus : true,
								displayField : 'name',
				...
				items : [
					{
						...
						allowBlank:false,
						name:'name',
						fieldLabel:'<s:text name="vCultivateManager.name"/>'
					}
				]
			},
			{
				...
				items : [
					{
						...
						name:'galleryful',
						fieldLabel:'<s:text name="vCultivateManager.galleryful"/>'
					}
					,{
						flex:1,
						xtype : 'container',
			...
			},
			{
				...
				items : [{
							...
							name : 'equipment',
							itemId : 'equipment',
							fieldLabel : '<s:text name="vCultivateManager.equipment"/>',
							xtype : 'combo',
							value : '',
				...
				items : [
					{
						flex:1,
						name:'intro',
						fieldLabel:'<s:text name="vCultivateManager.intro"/>'
				...
				items : [
					{
					  ...
					  itemId : 'uploadFile',
						emptyText : '请选择上传文件...',
						fieldLabel : '<s:text name="cultivateManager.pic"/>',
						buttonText : '',
						buttonConfig : {
							iconCls : 'uploadPic'
						}
					...
					handler : function() {
						...
						if (saveForm.getForm().isValid()) {
							saveFile(saveForm, 'uploadFile', fileTypes,
									'product/cultivateRoom!saveImg', grid);
						}
					}
				}, {
					text : '关闭',
	...
	buttons : [
			{
				...
				handler : function() {
					var saveForm = this.up('form');
					if (saveForm.getForm().isValid()) {
						saveFormToDB(saveForm, 'product/cultivateRoom!save', grid);
					}
				}
			}, {
				text : '关闭',
