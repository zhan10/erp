...
Ext.onReady(function() {	
	var item=Ext.create('Ext.Panel',{title:'',autoScroll:true,hidden:true});
			var item1 = Ext.create('Ext.Panel', {
				title : '原材料设置',autoScroll :true,
				//html : '&lt;empty panel&gt;',
				items : [{
					xtype : 'label',
					html : '<a href="mater/mater_manager" target="rightFrame"><img src="img/nav/od2.png" width=48,height=48/><br>原材料管理</a><br><br>'
				},{
					xtype : 'label',
					html : '<a href="mater/mateType_manager" target="rightFrame"><img src="img/nav/od2.png" width=48,height=48/><br>类型设置</a><br>'
				}
				],
				cls : 'empty'
			});
