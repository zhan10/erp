...
<head>
	...
	<%@ include file="recipeDefine.jsp"%>
	<%@ include file="recipeDataExt.jsp"%>
	<%@ include file="recipeFormExt.jsp"%>
	<%@ include file="recipeSearchExt.jsp"%>
</head>
<body>
	<script language="javascript">
		...
		Ext.onReady(function() {
			...
			ds = getDs(mainFields, 'restaurant/recipe!managerExt', baseSql,order);
			ds.load();
			...
			tbar = Ext.create('Ext.toolbar.Toolbar',{
				...
				var contextMenu = Ext.create('Ext.menu.Menu', {
					 items: [
						showAction,'-'
						<sec:authorize url="/restaurant/recipe!add">,addAction,copyAddAction</sec:authorize>
						<sec:authorize url="/restaurant/recipe!edit">,editAction</sec:authorize>
						<sec:authorize url="/restaurant/recipe!del">,delAction</sec:authorize>
					 ]
				});
