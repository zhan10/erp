...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="vOrdersList.id"/>'],
		[ 'numbers', '<s:text name="vOrdersList.numbers"/>'],
		[ 'total', '<s:text name="vOrdersList.total"/>'],
		[ 'memo', '<s:text name="vOrdersList.memo"/>'],
		[ 'recipeName', '<s:text name="vOrdersList.recipeName"/>'],
		[ 'price', '<s:text name="vOrdersList.price"/>'],
		[ 'consumerName', '<s:text name="vOrdersList.consumerName"/>'],
		[ 'address', '<s:text name="vOrdersList.address"/>'],
		[ 'arrTime', '<s:text name="vOrdersList.arrTime"/>'],
		[ 'ordersTime', '<s:text name="vOrdersList.ordersTime"/>'],
		[ 'recipeId', '<s:text name="vOrdersList.recipeId"/>'],
		[ 'consumerId', '<s:text name="vOrdersList.consumerId"/>'],
		[ 'bookingId', '<s:text name="vOrdersList.bookingId"/>'],
		[ 'buildingId', '<s:text name="vOrdersList.buildingId"/>'],
		[ 'ordersId', '<s:text name="vOrdersList.ordersId"/>'],
		[ 'status', '<s:text name="vOrdersList.status"/>']
	];
