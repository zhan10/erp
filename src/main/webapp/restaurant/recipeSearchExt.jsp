...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="recipe.id"/>'],
		[ 'recipeType', '<s:text name="recipe.recipeType"/>'],
		[ 'keyword', '<s:text name="recipe.keyword"/>'],
		[ 'spicy', '<s:text name="recipe.spicy"/>'],
		[ 'name', '<s:text name="recipe.name"/>'],
		[ 'price', '<s:text name="recipe.price"/>'],
		[ 'pic', '<s:text name="recipe.pic"/>'],
		[ 'memo', '<s:text name="recipe.memo"/>']
	];
