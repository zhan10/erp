...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="orders.id"/>'],
		[ 'buildingId', '<s:text name="orders.buildingId"/>'],
		[ 'bookingId', '<s:text name="orders.bookingId"/>'],
		[ 'ordersTime', '<s:text name="orders.ordersTime"/>'],
		[ 'status', '<s:text name="orders.status"/>'],
		[ 'consumerId', '<s:text name="orders.consumerId"/>'],
		[ 'total', '<s:text name="orders.total"/>'],
		[ 'address', '<s:text name="orders.address"/>'],
		[ 'arrTime', '<s:text name="orders.arrTime"/>'],
		[ 'memo', '<s:text name="orders.memo"/>']
	];
