...
<head>
	...
	<%@ include file="ordersListDefine.jsp"%>
	<%@ include file="ordersListDataExt.jsp"%>
	<%@ include file="ordersListFormExt.jsp"%>
	<%@ include file="ordersListSearchExt.jsp"%>
</head>
<body>
	<script language="javascript">
		...
		Ext.onReady(function() {
			...
			ds = getDs(mainFields, 'restaurant/ordersList!managerExt', baseSql,order);
			ds.load();
