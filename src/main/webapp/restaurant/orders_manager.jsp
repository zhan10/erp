...
<head>
	...
	<%@ include file="ordersDefine.jsp"%>
	<%@ include file="ordersDataExt.jsp"%>
	<%@ include file="ordersFormExt.jsp"%>
	<%@ include file="ordersSearchExt.jsp"%>
</head>
<body>
	<script language="javascript">
		...
		Ext.onReady(function() {
			...
			ds = getDs(mainFields, 'restaurant/orders!managerExt', baseSql,order);
			ds.load();
			...
			tbar = Ext.create('Ext.toolbar.Toolbar',{
				...
				items : [
					...
					}),
					{
						...
						<sec:authorize url="/restaurant/orders!del">
				...
				var contextMenu = Ext.create('Ext.menu.Menu', {
					 items: [
						...
						<sec:authorize url="/restaurant/orders!del">,delAction</sec:authorize>
					 ]
				});
