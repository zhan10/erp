...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="ordersList.id"/>'],
		[ 'ordersId', '<s:text name="ordersList.ordersId"/>'],
		[ 'recipeId', '<s:text name="ordersList.recipeId"/>'],
		[ 'numbers', '<s:text name="ordersList.numbers"/>'],
		[ 'total', '<s:text name="ordersList.total"/>'],
		[ 'memo', '<s:text name="ordersList.memo"/>']
	];
