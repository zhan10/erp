				...
				items : [
					{
						...
						allowBlank:false,
						name:'productId',
						fieldLabel:'<s:text name="vMeetingRoomLock.productName"/>',
						xtype : 'combo',
						value : '',
						selectOnFocus : true,
						displayField : 'name',
				...
				items : [
					{
						...
						name:'lockFrom',
						itemId:'lockFrom',
						fieldLabel:'<s:text name="vMeetingRoomLock.lockFrom"/>',
						xtype:'datetimefield',
						format: 'Y-m-d'				
					}
					,
					{
						...
						name:'lockTo',
						itemId:'lockTo',
						fieldLabel:'<s:text name="vMeetingRoomLock.lockTo"/>',
						xtype:'datetimefield',
						format: 'Y-m-d'
					}
			...
			handler : function() {
				...
				if(lockFrom<myDate){
					...
					if (saveForm.getForm().isValid()) {
						saveFormToDB(saveForm, 'products/meetingRoomLock!save',grid);
					}
				}
			}
		}, {
