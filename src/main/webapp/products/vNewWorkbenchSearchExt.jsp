...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="vNewWorkbench.id"/>'],
		[ 'buildingId', '<s:text name="vNewWorkbench.buildingId"/>'],
		[ 'buildingName', '<s:text name="vNewWorkbench.buildingName"/>'],
		[ 'floorId', '<s:text name="vNewWorkbench.floorId"/>'],
		...
		[ 'planePic', '<s:text name="vNewWorkbench.planePic"/>'],
		[ 'coverPic', '<s:text name="vNewWorkbench.coverPic"/>'],
		[ 'intro', '<s:text name="vNewWorkbench.intro"/>']
	];
