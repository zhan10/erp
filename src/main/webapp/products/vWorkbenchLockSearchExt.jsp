...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="vWorkbenchLock.id"/>'],
		[ 'buildingName', '<s:text name="vWorkbenchLock.buildingName"/>'],
		[ 'floorName', '<s:text name="vWorkbenchLock.floorName"/>'],
		[ 'productName', '<s:text name="vWorkbenchLock.productName"/>'],
		[ 'quantity', '<s:text name="vWorkbenchLock.quantity"/>'],
		[ 'productId', '<s:text name="vWorkbenchLock.productId"/>'],
		[ 'createTime', '<s:text name="vWorkbenchLock.createTime"/>']
	];
