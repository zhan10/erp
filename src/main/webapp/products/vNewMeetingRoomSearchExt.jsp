...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="vNewMeetingRoom.id"/>'],
		...
		[ 'planePic', '<s:text name="vNewMeetingRoom.planePic"/>'],
		[ 'coverPic', '<s:text name="vNewMeetingRoom.coverPic"/>'],
		[ 'intro', '<s:text name="vNewMeetingRoom.intro"/>'],
		[ 'buildingId', '<s:text name="vNewMeetingRoom.buildingId"/>'],
		[ 'floorId', '<s:text name="vNewMeetingRoom.floorId"/>']
	];
