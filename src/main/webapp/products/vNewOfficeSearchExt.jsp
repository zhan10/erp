...
<script>
	...
	var searchColumns = [
		...
		[ 'planePic', '<s:text name="vNewOffice.planePic"/>'],
		[ 'coverPic', '<s:text name="vNewOffice.coverPic"/>'],
		[ 'intro', '<s:text name="vNewOffice.intro"/>'],
		[ 'buildingId', '<s:text name="vNewOffice.buildingId"/>'],
		[ 'floorId', '<s:text name="vNewOffice.floorId"/>']
	];
