...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="vOfficeLock.id"/>'],
		[ 'buildingName', '<s:text name="vOfficeLock.buildingName"/>'],
		[ 'floorName', '<s:text name="vOfficeLock.floorName"/>'],
		...
		[ 'productId', '<s:text name="vOfficeLock.productId"/>']
	];
