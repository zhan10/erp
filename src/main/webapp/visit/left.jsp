...
Ext.onReady(function() {	
	var item=Ext.create('Ext.Panel',{title:'',autoScroll:true,hidden:true});
			var item1 = Ext.create('Ext.Panel', {
				...
				items : [{
					xtype : 'label',
					html : '<a href="visit/vVisit_manager" target="rightFrame"><img src="img/nav/od2.png" width=48,height=48/><br>预约参观</a><br>'
				}
				],
				cls : 'empty'
			});
			var item2 = Ext.create('Ext.Panel', {
				title : '预约参数设置',autoScroll :true,
				//html : '&lt;empty panel&gt;',
				items : [{
					xtype : 'label',
					html : '<a href="visit/visitService_manager" target="rightFrame"><img src="img/nav/od2.png" width=48,height=48/><br>客服设置</a><br>'
				}
				],
				cls : 'empty'
			});
			var accordion = Ext
					.create(
							'Ext.Panel',
							{
								...
								title : '预约管理',									
								itemCls:'required',
								items : [ <sec:authorize url="/visit/A">item1</sec:authorize><sec:authorize url="/visit/A">,item2</sec:authorize>],
								listeners : {
