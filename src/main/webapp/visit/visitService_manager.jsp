...
<head>
	...
	<%@ include file="visitServiceDefine.jsp"%>
	<%@ include file="visitServiceDataExt.jsp"%>
	<%@ include file="visitServiceFormExt.jsp"%>
	<%@ include file="visitServiceSearchExt.jsp"%>
</head>
<body>
	<script language="javascript">
		...
		Ext.onReady(function() {
			...
			ds = getDs(mainFields, 'visit/visitService!managerExt', baseSql,order);
			ds.load();
			...
			tbar = Ext.create('Ext.toolbar.Toolbar',{
				...
				items : [
					Ext.create('Ext.form.field.ComboBox',{
						...
						store : [
							['','选择排序' ]
							,['servicename', '<s:text name="visitService.servicename" />']
						]
					}),
					Ext.create('Ext.form.field.ComboBox',{
						itemId : 'orderType',
					...
					}),
					{
						...
						'->','-'
						/*<sec:authorize url="/visit/visitService!add">
						,getAddButton(win,winTitle + '——新增','新增'),
						getCopyAddButton(win,winTitle + '——拷贝添加', sm,'拷贝添加')
						</sec:authorize> */
						<sec:authorize url="/visit/visitService!edit">
						,getEditButton(win,winTitle+'——修改', sm,'修改')
						</sec:authorize>
						/* <sec:authorize url="/visit/visitService!del">
						,getDelButton(ds, sm, 'visit/visitService!delete','删除')
						</sec:authorize>
				...
				var delAction = Ext.create('Ext.Action', {
					iconCls: 'delete',
					 text: '删除',
						handler: function(widget, event) {   
						delFromDB(ds,sm,'visit/visitService!delete',function(){});
					}
				});
				var contextMenu = Ext.create('Ext.menu.Menu', {
					 items: [
						showAction,'-'
						/* <sec:authorize url="/visit/visitService!add">,addAction,copyAddAction</sec:authorize> */
						<sec:authorize url="/visit/visitService!edit">,editAction</sec:authorize>
						/* <sec:authorize url="/visit/visitService!del">,delAction</sec:authorize> */
					 ]
				});
