...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="vVisit.id"/>'],
		[ 'floorId', '<s:text name="vVisit.floorId"/>'],
		...
		[ 'createtime', '<s:text name="vVisit.createtime"/>'],
		[ 'deadlinetime', '<s:text name="vVisit.deadlinetime"/>'],
		[ 'floorName', '<s:text name="vVisit.floorName"/>'],
		[ 'buildingName', '<s:text name="vVisit.buildingName"/>'],
		[ 'cityName', '<s:text name="vVisit.cityName"/>'],
		[ 'buildingId', '<s:text name="vVisit.buildingId"/>'],
		[ 'cityId', '<s:text name="vVisit.cityId"/>']
	];
