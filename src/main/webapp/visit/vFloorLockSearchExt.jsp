...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="vFloorLock.id"/>'],
		[ 'floorId', '<s:text name="vFloorLock.floorId"/>'],
		[ 'lockFrom', '<s:text name="vFloorLock.lockFrom"/>'],
		[ 'lockTo', '<s:text name="vFloorLock.lockTo"/>'],
		[ 'createTime', '<s:text name="vFloorLock.createTime"/>'],
		[ 'cityId', '<s:text name="vFloorLock.cityId"/>'],
		[ 'cityName', '<s:text name="vFloorLock.cityName"/>'],
		[ 'buildingId', '<s:text name="vFloorLock.buildingId"/>'],
