	...
	Ext.onReady(function() {
				...
				var item1 = Ext.create('Ext.Panel', {
					...
					items : [
								{
									xtype : 'label',
									html : '<br><a href="design/vErpOrders_manager" target="rightFrame"><img src="img/nav/ordersItem7.png" width=48,height=48/><br>设计管理</a><br>'
							    }
							],
					cls : 'empty'
				});
				...
				var accordion = Ext
						.create(
								'Ext.Panel',
								{
									...
									title : '设计管理',									
									itemCls:'required',
									items : [<sec:authorize url="/design/order">item1</sec:authorize>],
									listeners : {
