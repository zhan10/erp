...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="resource.id"/>'],
		[ 'name', '<s:text name="resource.name"/>'],
		[ 'url', '<s:text name="resource.url"/>'],
		[ 'type', '<s:text name="resource.type"/>'],
		[ 'info', '<s:text name="resource.info"/>'],
		[ 'enable', '<s:text name="resource.enable"/>'],
		[ 'layer', '<s:text name="resource.layer"/>'],
		[ 'parentId', '<s:text name="resource.parentId"/>']
	];
