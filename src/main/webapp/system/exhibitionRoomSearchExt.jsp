...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="exhibitionRoom.id"/>'],
		[ 'name', '<s:text name="exhibitionRoom.name"/>'],
		[ 'price', '<s:text name="exhibitionRoom.price"/>'],
		[ 'intro', '<s:text name="exhibitionRoom.intro"/>'],
		[ 'pic', '<s:text name="exhibitionRoom.pic"/>'],
		[ 'galleryful', '<s:text name="exhibitionRoom.galleryful"/>'],
		[ 'floorId', '<s:text name="exhibitionRoom.floorId"/>'],
		[ 'equipment', '<s:text name="exhibitionRoom.equipment"/>']
	];
