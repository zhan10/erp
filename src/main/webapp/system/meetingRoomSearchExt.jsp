...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="meetingRoom.id"/>'],
		[ 'name', '<s:text name="meetingRoom.name"/>'],
		[ 'price', '<s:text name="meetingRoom.price"/>'],
		[ 'intro', '<s:text name="meetingRoom.intro"/>'],
		[ 'pic', '<s:text name="meetingRoom.pic"/>'],
		[ 'galleryful', '<s:text name="meetingRoom.galleryful"/>'],
		[ 'floorId', '<s:text name="meetingRoom.floorId"/>'],
		[ 'equipment', '<s:text name="meetingRoom.equipment"/>']
	];
