...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="telRoom.id"/>'],
		[ 'name', '<s:text name="telRoom.name"/>'],
		[ 'price', '<s:text name="telRoom.price"/>'],
		[ 'intro', '<s:text name="telRoom.intro"/>'],
		[ 'pic', '<s:text name="telRoom.pic"/>'],
		[ 'galleryful', '<s:text name="telRoom.galleryful"/>'],
		[ 'floorId', '<s:text name="telRoom.floorId"/>'],
		[ 'equipment', '<s:text name="telRoom.equipment"/>']
	];
