...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="workbench.id"/>'],
		[ 'typeId', '<s:text name="workbench.typeId"/>'],
		[ 'name', '<s:text name="workbench.name"/>'],
		[ 'intro', '<s:text name="workbench.intro"/>'],
		[ 'floorId', '<s:text name="workbench.floorId"/>'],
		[ 'pic', '<s:text name="workbench.pic"/>']
	];
