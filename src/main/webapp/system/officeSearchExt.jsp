...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="office.id"/>'],
		[ 'typeId', '<s:text name="office.typeId"/>'],
		[ 'name', '<s:text name="office.name"/>'],
		[ 'intro', '<s:text name="office.intro"/>'],
		[ 'floorId', '<s:text name="office.floorId"/>'],
		[ 'pic', '<s:text name="office.pic"/>'],
		[ 'persons', '<s:text name="office.persons"/>']
	];
