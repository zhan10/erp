...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="building.id"/>'],
		[ 'name', '<s:text name="building.name"/>'],
		[ 'areaId', '<s:text name="building.areaId"/>'],
		[ 'circleId', '<s:text name="building.circleId"/>'],
		[ 'intro', '<s:text name="building.intro"/>'],
		[ 'traffic', '<s:text name="building.traffic"/>'],
		[ 'pic', '<s:text name="building.pic"/>']
	];
