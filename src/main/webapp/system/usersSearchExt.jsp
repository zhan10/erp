...
<script>
	var rBrackets = [ ')', '' ];
var searchColumns = [ [ 'id', '<s:text name="users.id" />' ],
          			[ 'name', '<s:text name="users.name" />' ],
          			[ 'code', '<s:text name="users.code" />' ],
          			//[ 'password', '<s:text name="users.password" />' ],
          			[ 'birth', '<s:text name="users.birth" />' ],
          			[ 'sex', '<s:text name="users.sex" />' ],
          			//[ 'dept', '<s:text name="users.dept" />' ],
          			[ 'enable', '<s:text name="users.enable" />' ],
          			[ 'status', '<s:text name="users.status" />' ]];
