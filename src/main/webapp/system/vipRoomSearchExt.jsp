...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="vipRoom.id"/>'],
		[ 'name', '<s:text name="vipRoom.name"/>'],
		[ 'price', '<s:text name="vipRoom.price"/>'],
		[ 'intro', '<s:text name="vipRoom.intro"/>'],
		[ 'pic', '<s:text name="vipRoom.pic"/>'],
		[ 'galleryful', '<s:text name="vipRoom.galleryful"/>'],
		[ 'floorId', '<s:text name="vipRoom.floorId"/>'],
		[ 'equipment', '<s:text name="vipRoom.equipment"/>']
	];
