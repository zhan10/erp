...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="vBookingTelRoom.id"/>'],
		[ 'balance', '<s:text name="vBookingTelRoom.balance"/>'],
		[ 'code', '<s:text name="vBookingTelRoom.code"/>'],
		[ 'dateFrom', '<s:text name="vBookingTelRoom.dateFrom"/>'],
		[ 'dateTo', '<s:text name="vBookingTelRoom.dateTo"/>'],
		[ 'cityName', '<s:text name="vBookingTelRoom.cityName"/>'],
		[ 'areaName', '<s:text name="vBookingTelRoom.areaName"/>'],
		[ 'buildingName', '<s:text name="vBookingTelRoom.buildingName"/>'],
		[ 'floorName', '<s:text name="vBookingTelRoom.floorName"/>'],
		[ 'telRoomName', '<s:text name="vBookingTelRoom.telRoomName"/>'],
		[ 'consumerName', '<s:text name="vBookingTelRoom.consumerName"/>'],
		[ 'total', '<s:text name="vBookingTelRoom.total"/>'],
		[ 'price', '<s:text name="vBookingTelRoom.price"/>'],
		[ 'balanceTime', '<s:text name="vBookingTelRoom.balanceTime"/>'],
		[ 'balancePrice', '<s:text name="vBookingTelRoom.balancePrice"/>']
	];
