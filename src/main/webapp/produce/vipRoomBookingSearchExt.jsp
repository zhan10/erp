...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="vipRoomBooking.id"/>'],
		[ 'vipRoomId', '<s:text name="vipRoomBooking.vipRoomId"/>'],
		[ 'bookingId', '<s:text name="vipRoomBooking.bookingId"/>'],
		[ 'dateFrom', '<s:text name="vipRoomBooking.dateFrom"/>'],
		[ 'dateTo', '<s:text name="vipRoomBooking.dateTo"/>'],
		[ 'price', '<s:text name="vipRoomBooking.price"/>'],
		[ 'total', '<s:text name="vipRoomBooking.total"/>'],
		[ 'consumerId', '<s:text name="vipRoomBooking.consumerId"/>'],
		[ 'balance', '<s:text name="vipRoomBooking.balance"/>'],
		[ 'balanceTime', '<s:text name="vipRoomBooking.balanceTime"/>'],
		[ 'balancePrice', '<s:text name="vipRoomBooking.balancePrice"/>']
	];
