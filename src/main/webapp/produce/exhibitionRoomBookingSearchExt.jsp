...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="exhibitionRoomBooking.id"/>'],
		[ 'exhibitionRoomId', '<s:text name="exhibitionRoomBooking.exhibitionRoomId"/>'],
		[ 'bookingId', '<s:text name="exhibitionRoomBooking.bookingId"/>'],
		[ 'dateFrom', '<s:text name="exhibitionRoomBooking.dateFrom"/>'],
		[ 'dateTo', '<s:text name="exhibitionRoomBooking.dateTo"/>'],
		[ 'price', '<s:text name="exhibitionRoomBooking.price"/>'],
		[ 'total', '<s:text name="exhibitionRoomBooking.total"/>'],
		[ 'consumerId', '<s:text name="exhibitionRoomBooking.consumerId"/>'],
		[ 'balance', '<s:text name="exhibitionRoomBooking.balance"/>'],
		[ 'balanceTime', '<s:text name="exhibitionRoomBooking.balanceTime"/>'],
		[ 'balancePrice', '<s:text name="exhibitionRoomBooking.balancePrice"/>']
	];
