...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="vOrders.id"/>'],
		[ 'status', '<s:text name="vOrders.status"/>'],
		[ 'customId', '<s:text name="vOrders.customId"/>'],
		[ 'salesId', '<s:text name="vOrders.salesId"/>'],
		[ 'ordersNum', '<s:text name="vOrders.ordersNum"/>'],
		[ 'salesName', '<s:text name="vOrders.salesName"/>'],
		[ 'contractDate', '<s:text name="vOrders.contractDate"/>'],
		[ 'customCode', '<s:text name="vOrders.customCode"/>'],
		[ 'customName', '<s:text name="vOrders.customName"/>'],
		[ 'sumWeight', '<s:text name="vOrders.sumWeight"/>'],
		[ 'orderWeight', '<s:text name="vOrders.orderWeight"/>'],
		[ 'produceWeight', '<s:text name="vOrders.produceWeight"/>'],
		[ 'storeLimit', '<s:text name="vOrders.storeLimit"/>'],
		[ 'hasOrder', '<s:text name="vOrders.hasOrder"/>'],
		[ 'hasPrice', '<s:text name="vOrders.hasPrice"/>'],
		[ 'purchaseOrder', '<s:text name="vOrders.purchaseOrder"/>'],
		[ 'memo', '<s:text name="vOrders.memo"/>']
	];
