...
<%@ include file="vBookingVipRoomDefine.jsp"%>
<%@ include file="vBookingVipRoomDataExt.jsp"%>
<%@ include file="vBookingVipRoomFormExt.jsp"%>
<%@ include file="vBookingVipRoomSearchExt.jsp"%>
</head>
<body>
	<script language="javascript">
		...
		Ext.onReady(function() {
			...
			ds = getDs(mainFields, 'produce/vBookingVipRoom!managerExt', baseSql,order);
			ds.load();
			...
			tbar = Ext.create('Ext.toolbar.Toolbar',{
				...
				items : [
					...
					}),
					{
						...
						'->','-'
						<sec:authorize url="/produce/vBookingVipRoom!balance">
						...
						<sec:authorize url="/produce/vBookingVipRoom!nobalance">
						,Ext.create('Ext.Button', {
							text : '取消结算',
							tooltip : '取消订单结算',
						...
						<sec:authorize url="/produce/vBookingVipRoom!del">
