...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="meetingRoomBooking.id"/>'],
		[ 'meetingRoomId', '<s:text name="meetingRoomBooking.meetingRoomId"/>'],
		[ 'bookingId', '<s:text name="meetingRoomBooking.bookingId"/>'],
		[ 'dateFrom', '<s:text name="meetingRoomBooking.dateFrom"/>'],
		[ 'dateTo', '<s:text name="meetingRoomBooking.dateTo"/>'],
		[ 'price', '<s:text name="meetingRoomBooking.price"/>'],
		[ 'total', '<s:text name="meetingRoomBooking.total"/>'],
		[ 'consumerId', '<s:text name="meetingRoomBooking.consumerId"/>'],
		[ 'balance', '<s:text name="meetingRoomBooking.balance"/>'],
		[ 'balanceTime', '<s:text name="meetingRoomBooking.balanceTime"/>'],
		[ 'balancePrice', '<s:text name="meetingRoomBooking.balancePrice"/>']
	];
