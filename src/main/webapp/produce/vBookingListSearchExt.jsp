...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="vBookingList.id"/>'],
		[ 'status', '<s:text name="vBookingList.status"/>'],
		[ 'code', '<s:text name="vBookingList.code"/>'],
		[ 'name', '<s:text name="vBookingList.name"/>'],
		[ 'total', '<s:text name="vBookingList.total"/>'],
	];
