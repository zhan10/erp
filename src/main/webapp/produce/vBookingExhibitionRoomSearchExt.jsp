...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="vBookingExhibitionRoom.id"/>'],
		[ 'balance', '<s:text name="vBookingExhibitionRoom.balance"/>'],
		[ 'code', '<s:text name="vBookingExhibitionRoom.code"/>'],
		[ 'dateFrom', '<s:text name="vBookingExhibitionRoom.dateFrom"/>'],
		[ 'dateTo', '<s:text name="vBookingExhibitionRoom.dateTo"/>'],
		[ 'cityName', '<s:text name="vBookingExhibitionRoom.cityName"/>'],
		[ 'areaName', '<s:text name="vBookingExhibitionRoom.areaName"/>'],
		[ 'buildingName', '<s:text name="vBookingExhibitionRoom.buildingName"/>'],
		[ 'floorName', '<s:text name="vBookingExhibitionRoom.floorName"/>'],
		[ 'exhibitionRoomName', '<s:text name="vBookingExhibitionRoom.exhibitionRoomName"/>'],
		[ 'consumerName', '<s:text name="vBookingExhibitionRoom.consumerName"/>'],
		[ 'total', '<s:text name="vBookingExhibitionRoom.total"/>'],
		[ 'price', '<s:text name="vBookingExhibitionRoom.price"/>'],
		[ 'balanceTime', '<s:text name="vBookingExhibitionRoom.balanceTime"/>'],
		[ 'balancePrice', '<s:text name="vBookingExhibitionRoom.balancePrice"/>']
	];
