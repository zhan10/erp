...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="officeBooking.id"/>'],
		[ 'officeId', '<s:text name="officeBooking.officeId"/>'],
		[ 'bookingId', '<s:text name="officeBooking.bookingId"/>'],
		[ 'dateFrom', '<s:text name="officeBooking.dateFrom"/>'],
		[ 'dateTo', '<s:text name="officeBooking.dateTo"/>'],
		[ 'price', '<s:text name="officeBooking.price"/>'],
		[ 'total', '<s:text name="officeBooking.total"/>'],
		[ 'consumerId', '<s:text name="officeBooking.consumerId"/>'],
		[ 'balance', '<s:text name="officeBooking.balance"/>']
	];
