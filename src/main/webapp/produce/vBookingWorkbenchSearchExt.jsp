...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'balance', '<s:text name="vBookingWorkbench.balance"/>'],
		[ 'code', '<s:text name="vBookingWorkbench.code"/>'],
		[ 'dateFrom', '<s:text name="vBookingWorkbench.dateFrom"/>'],
		[ 'dateTo', '<s:text name="vBookingWorkbench.dateTo"/>'],
		[ 'cityName', '<s:text name="vBookingWorkbench.cityName"/>'],
		[ 'areaName', '<s:text name="vBookingWorkbench.areaName"/>'],
		[ 'buildingName', '<s:text name="vBookingWorkbench.buildingName"/>'],
		[ 'floorName', '<s:text name="vBookingWorkbench.floorName"/>'],
		[ 'workbenchName', '<s:text name="vBookingWorkbench.workbenchName"/>'],
		[ 'consumerName', '<s:text name="vBookingWorkbench.consumerName"/>'],
		[ 'total', '<s:text name="vBookingWorkbench.total"/>'],
		[ 'price', '<s:text name="vBookingWorkbench.price"/>'],
		[ 'balanceTime', '<s:text name="vBookingWorkbench.balanceTime"/>'],
		[ 'balancePrice', '<s:text name="vBookingWorkbench.balancePrice"/>']
	];
