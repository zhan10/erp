...
<head>
	...
	<%@ include file="bookingDefine.jsp"%>
	<%@ include file="bookingDataExt.jsp"%>
	<%@ include file="bookingFormExt.jsp"%>
	<%@ include file="bookingSearchExt.jsp"%>
</head>
<body>
	<script language="javascript">
		...
		Ext.onReady(function() {
			...
			ds = getDs(mainFields, 'produce/booking!managerExt', baseSql,order);
			ds.load();
			...
			tbar = Ext.create('Ext.toolbar.Toolbar',{
				...
				items : [
					...
					}),
					{
						...
						<sec:authorize url="/produce/booking!edit">
						,getEditButton(win,winTitle+'——修改', sm,'修改'),
						getBatchButton(batchWin,sm,'批量修改')
						</sec:authorize>
						<sec:authorize url="/produce/booking!del">
				...
				var contextMenu = Ext.create('Ext.menu.Menu', {
					 items: [
						...
						<sec:authorize url="/produce/booking!edit">,editAction</sec:authorize>
						<sec:authorize url="/produce/booking!del">,delAction</sec:authorize>
					 ]
				});
