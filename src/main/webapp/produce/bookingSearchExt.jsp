...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="booking.id"/>'],
		[ 'buildingId', '<s:text name="booking.buildingId"/>'],
		[ 'code', '<s:text name="booking.code"/>'],
		[ 'persons', '<s:text name="booking.persons"/>'],
		[ 'bookingTime', '<s:text name="booking.bookingTime"/>'],
		[ 'status', '<s:text name="booking.status"/>'],
		[ 'consumerId', '<s:text name="booking.consumerId"/>']
	];
