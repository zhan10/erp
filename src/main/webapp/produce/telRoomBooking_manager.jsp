...
<head>
	...
	<%@ include file="telRoomBookingDefine.jsp"%>
	<%@ include file="telRoomBookingDataExt.jsp"%>
	<%@ include file="telRoomBookingFormExt.jsp"%>
	<%@ include file="telRoomBookingSearchExt.jsp"%>
</head>
<body>
	<script language="javascript">
		...
		Ext.onReady(function() {
			...
			ds = getDs(mainFields, 'produce/telRoomBooking!managerExt', baseSql,order);
			ds.load();
			...
			tbar = Ext.create('Ext.toolbar.Toolbar',{
				...
				var delAction = Ext.create('Ext.Action', {
					iconCls: 'delete',
					 text: '删除',
						handler: function(widget, event) {   
						delFromDB(ds,sm,'produce/telRoomBooking!delete',function(){});
					}
				});
				var contextMenu = Ext.create('Ext.menu.Menu', {
					 items: [
						showAction,'-'
						<sec:authorize url="/produce/telRoomBooking!add">,addAction,copyAddAction</sec:authorize>
						<sec:authorize url="/produce/telRoomBooking!edit">,editAction</sec:authorize>
						<sec:authorize url="/produce/telRoomBooking!del">,delAction</sec:authorize>
					 ]
				});
