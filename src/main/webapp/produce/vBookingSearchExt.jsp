...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="vBooking.id"/>'],
		[ 'status', '<s:text name="vBooking.status"/>'],
		[ 'buildingName', '<s:text name="vBooking.buildingName"/>'],
		[ 'cityName', '<s:text name="vBooking.cityName"/>'],
		[ 'areaName', '<s:text name="vBooking.areaName"/>'],
		[ 'code', '<s:text name="vBooking.code"/>'],
		[ 'persons', '<s:text name="vBooking.persons"/>'],
		[ 'bookingTime', '<s:text name="vBooking.bookingTime"/>'],
		[ 'consumerName', '<s:text name="vBooking.consumerName"/>'],
		[ 'tel', '<s:text name="vBooking.tel"/>'],
		[ 'consumerId', '<s:text name="vBooking.consumerId"/>'],
		[ 'areaId', '<s:text name="vBooking.areaId"/>'],
		[ 'buildingId', '<s:text name="vBooking.buildingId"/>']
	];
