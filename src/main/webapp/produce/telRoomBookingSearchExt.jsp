...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="telRoomBooking.id"/>'],
		[ 'telRoomId', '<s:text name="telRoomBooking.telRoomId"/>'],
		[ 'bookingId', '<s:text name="telRoomBooking.bookingId"/>'],
		[ 'dateFrom', '<s:text name="telRoomBooking.dateFrom"/>'],
		[ 'dateTo', '<s:text name="telRoomBooking.dateTo"/>'],
		[ 'price', '<s:text name="telRoomBooking.price"/>'],
		[ 'total', '<s:text name="telRoomBooking.total"/>'],
		[ 'consumerId', '<s:text name="telRoomBooking.consumerId"/>'],
		[ 'balance', '<s:text name="telRoomBooking.balance"/>'],
		[ 'balanceTime', '<s:text name="telRoomBooking.balanceTime"/>'],
		[ 'balancePrice', '<s:text name="telRoomBooking.balancePrice"/>']
	];
