...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="vBookingOffice.id"/>'],
		[ 'balance', '<s:text name="vBookingOffice.balance"/>'],
		[ 'code', '<s:text name="vBookingOffice.code"/>'],
		[ 'dateFrom', '<s:text name="vBookingOffice.dateFrom"/>'],
		[ 'dateTo', '<s:text name="vBookingOffice.dateTo"/>'],
		[ 'cityName', '<s:text name="vBookingOffice.cityName"/>'],
		[ 'areaName', '<s:text name="vBookingOffice.areaName"/>'],
		[ 'buildingName', '<s:text name="vBookingOffice.buildingName"/>'],
		[ 'floorName', '<s:text name="vBookingOffice.floorName"/>'],
		[ 'officeName', '<s:text name="vBookingOffice.officeName"/>'],
		[ 'consumerName', '<s:text name="vBookingOffice.consumerName"/>'],
		[ 'total', '<s:text name="vBookingOffice.total"/>'],
		[ 'price', '<s:text name="vBookingOffice.price"/>'],
		[ 'balanceTime', '<s:text name="vBookingOffice.balanceTime"/>'],
		[ 'balancePrice', '<s:text name="vBookingOffice.balancePrice"/>']
	];
