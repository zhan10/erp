...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="vNewBookingList.id"/>'],
		[ 'status', '<s:text name="vNewBookingList.status"/>'],
		[ 'code', '<s:text name="vNewBookingList.code"/>'],
		[ 'productName', '<s:text name="vNewBookingList.productName"/>'],
		[ 'buildingName', '<s:text name="vNewBookingList.buildingName"/>'],
		[ 'consumerName', '<s:text name="vNewBookingList.consumerName"/>'],
		[ 'deposit', '<s:text name="vNewBookingList.deposit"/>'],
		[ 'quantity', '<s:text name="vNewBookingList.quantity"/>'],
		[ 'price', '<s:text name="vNewBookingList.price"/>'],
		...
		[ 'bookingTime', '<s:text name="vNewBookingList.bookingTime"/>'],
		[ 'tel', '<s:text name="vNewBookingList.tel"/>'],
		[ 'email', '<s:text name="vNewBookingList.email"/>'],
		[ 'productType', '<s:text name="vNewBookingList.productType"/>'],
		[ 'productId', '<s:text name="vNewBookingList.productId"/>'],
		[ 'consumerId', '<s:text name="vNewBookingList.consumerId"/>']
	];
