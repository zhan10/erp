...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="vInStorePlan.id"/>'],
		[ 'code', '<s:text name="vInStorePlan.code"/>'],
		[ 'deliverDept', '<s:text name="vInStorePlan.deliverDept"/>'],
		[ 'storeName', '<s:text name="vInStorePlan.storeName"/>'],
		[ 'storeDate', '<s:text name="vInStorePlan.storeDate"/>'],
		[ 'caseNum', '<s:text name="vInStorePlan.caseNum"/>'],
		[ 'sumWeight', '<s:text name="vInStorePlan.sumWeight"/>'],
		[ 'inputerName', '<s:text name="vInStorePlan.inputerName"/>'],
		[ 'inputDate', '<s:text name="vInStorePlan.inputDate"/>'],
		[ 'checkerName', '<s:text name="vInStorePlan.checkerName"/>'],
		[ 'checkDate', '<s:text name="vInStorePlan.checkDate"/>'],
		[ 'deliverName', '<s:text name="vInStorePlan.deliverName"/>'],
		[ 'accepterName', '<s:text name="vInStorePlan.accepterName"/>'],
		[ 'sourceType', '<s:text name="vInStorePlan.sourceType"/>'],
		[ 'sourceCode', '<s:text name="vInStorePlan.sourceCode"/>'],
		[ 'tatus', '<s:text name="vInStorePlan.tatus"/>'],
		[ 'storeType', '<s:text name="vInStorePlan.storeType"/>'],
		[ 'checker', '<s:text name="vInStorePlan.checker"/>'],
		[ 'storeId', '<s:text name="vInStorePlan.storeId"/>'],
		[ 'accepter', '<s:text name="vInStorePlan.accepter"/>'],
		[ 'inputer', '<s:text name="vInStorePlan.inputer"/>'],
		[ 'deliver', '<s:text name="vInStorePlan.deliver"/>'],
		[ 'storeKeeper', '<s:text name="vInStorePlan.storeKeeper"/>']
	];
