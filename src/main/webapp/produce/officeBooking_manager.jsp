...
<head>
	...
	<%@ include file="officeBookingDefine.jsp"%>
	<%@ include file="officeBookingDataExt.jsp"%>
	<%@ include file="officeBookingFormExt.jsp"%>
	<%@ include file="officeBookingSearchExt.jsp"%>
</head>
<body>
	<script language="javascript">
		...
		Ext.onReady(function() {
			...
			ds = getDs(mainFields, 'produce/officeBooking!managerExt', baseSql,order);
			ds.load();
			...
			tbar = Ext.create('Ext.toolbar.Toolbar',{
				...
				var delAction = Ext.create('Ext.Action', {
					iconCls: 'delete',
					 text: '删除',
						handler: function(widget, event) {   
						delFromDB(ds,sm,'produce/officeBooking!delete',function(){});
					}
				});
				var contextMenu = Ext.create('Ext.menu.Menu', {
					 items: [
						showAction,'-'
						<sec:authorize url="/produce/officeBooking!add">,addAction,copyAddAction</sec:authorize>
						<sec:authorize url="/produce/officeBooking!edit">,editAction</sec:authorize>
						<sec:authorize url="/produce/officeBooking!del">,delAction</sec:authorize>
					 ]
				});
