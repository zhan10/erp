...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="workbenchBooking.id"/>'],
		[ 'workbenchId', '<s:text name="workbenchBooking.workbenchId"/>'],
		[ 'bookingId', '<s:text name="workbenchBooking.bookingId"/>'],
		[ 'dateFrom', '<s:text name="workbenchBooking.dateFrom"/>'],
		[ 'dateTo', '<s:text name="workbenchBooking.dateTo"/>'],
		[ 'total', '<s:text name="workbenchBooking.total"/>'],
		[ 'consumerId', '<s:text name="workbenchBooking.consumerId"/>']
	];
