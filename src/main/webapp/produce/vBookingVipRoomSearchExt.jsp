...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="vBookingVipRoom.id"/>'],
		[ 'balance', '<s:text name="vBookingVipRoom.balance"/>'],
		[ 'code', '<s:text name="vBookingVipRoom.code"/>'],
		[ 'dateFrom', '<s:text name="vBookingVipRoom.dateFrom"/>'],
		[ 'dateTo', '<s:text name="vBookingVipRoom.dateTo"/>'],
		[ 'cityName', '<s:text name="vBookingVipRoom.cityName"/>'],
		[ 'areaName', '<s:text name="vBookingVipRoom.areaName"/>'],
		[ 'buildingName', '<s:text name="vBookingVipRoom.buildingName"/>'],
		[ 'floorName', '<s:text name="vBookingVipRoom.floorName"/>'],
		[ 'vipRoomName', '<s:text name="vBookingVipRoom.vipRoomName"/>'],
		[ 'consumerName', '<s:text name="vBookingVipRoom.consumerName"/>'],
		[ 'total', '<s:text name="vBookingVipRoom.total"/>'],
		[ 'price', '<s:text name="vBookingVipRoom.price"/>'],
		[ 'balanceTime', '<s:text name="vBookingVipRoom.balanceTime"/>'],
		[ 'balancePrice', '<s:text name="vBookingVipRoom.balancePrice"/>']
	];
