...
<script>
	var rBrackets = [ ')', '' ];
	var searchColumns = [
		[ 'id', '<s:text name="vBookingMeetingRoom.id"/>'],
		[ 'balance', '<s:text name="vBookingMeetingRoom.balance"/>'],
		[ 'code', '<s:text name="vBookingMeetingRoom.code"/>'],
		[ 'dateFrom', '<s:text name="vBookingMeetingRoom.dateFrom"/>'],
		[ 'dateTo', '<s:text name="vBookingMeetingRoom.dateTo"/>'],
		[ 'cityName', '<s:text name="vBookingMeetingRoom.cityName"/>'],
		[ 'areaName', '<s:text name="vBookingMeetingRoom.areaName"/>'],
		[ 'buildingName', '<s:text name="vBookingMeetingRoom.buildingName"/>'],
		[ 'floorName', '<s:text name="vBookingMeetingRoom.floorName"/>'],
		[ 'meetingRoomName', '<s:text name="vBookingMeetingRoom.meetingRoomName"/>'],
		[ 'consumerName', '<s:text name="vBookingMeetingRoom.consumerName"/>'],
		[ 'total', '<s:text name="vBookingMeetingRoom.total"/>'],
		[ 'price', '<s:text name="vBookingMeetingRoom.price"/>'],
		[ 'balanceTime', '<s:text name="vBookingMeetingRoom.balanceTime"/>'],
		[ 'balancePrice', '<s:text name="vBookingMeetingRoom.balancePrice"/>']
	];
