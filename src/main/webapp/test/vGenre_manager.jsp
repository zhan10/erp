...
<head>
	...
	<%@ include file="vGenreDefine.jsp"%>
	<%@ include file="vGenreDataExt.jsp"%>
	<%@ include file="../c/cb_productType.jsp"%>
	<%@ include file="vGenreFormExt.jsp"%>
	<%@ include file="vGenreSearchExt.jsp"%>
</head>
<body>
	<script language="javascript">
		...
		Ext.onReady(function() {
			...
			ds = getDs(mainFields, 'system/vGenre!managerExt', baseSql,order);
			ds.load();
			...
			tbar = Ext.create('Ext.toolbar.Toolbar',{
				padding : '5 0 5 10',
				items : [
				    getTextField('name', 100, '',0, '<s:text name="genre.name" />'),
		            '-',
					...
					}),
					{
						...
						,getDelButton(ds, sm, 'system/genre!delete','删除')
						</sec:authorize>
				...
				var delAction = Ext.create('Ext.Action', {
					iconCls: 'delete',
					 text: '删除',
						handler: function(widget, event) {   
						delFromDB(ds,sm,'system/officeType!delete',function(){});
					}
				});
